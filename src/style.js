...
export const textDayFontFamily = 'Manrope';
export const textMonthFontFamily = 'Manrope';
export const textDayHeaderFontFamily = 'Manrope';
export const todayButtonFontFamily = 'Manrope';
export const textDayFontWeight = '400';
export const textMonthFontWeight = '700';
export const textDayHeaderFontWeight = '700';
...
export const calendarBackground = '#F0F5FF';
export const textSectionTitleColor = '#294687';
export const textSectionTitleDisabledColor = DISABLED_COLOR;
export const selectedDayBackgroundColor = '#5F7AB8';
export const selectedDayTextColor = 'white';
export const todayBackgroundColor = '#5F7AB8';
export const todayTextColor = '#5F7AB8';
export const dayTextColor = '#5F7AB8';
...
export const arrowColor = '#294687';
export const disabledArrowColor = DISABLED_COLOR;
export const monthTextColor = '#294687';
